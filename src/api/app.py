...
async def run_analysis_phase1(session_id: str, email: Optional[str] = None):
    """Run Phase 1 analysis in background
    ...
    try:
        ...
        analysis_sessions[session_id]["progress"] = 50
        analysis_sessions[session_id]["message"] = "Fetching recent emails..."
        
        # Get email counts
        counts = fetcher.get_email_count()
        
        analysis_sessions[session_id]["progress"] = 70
        analysis_sessions[session_id]["message"] = "Analyzing emails..."
        ...
        analysis_sessions[session_id]["message"] = "Analysis complete!"
